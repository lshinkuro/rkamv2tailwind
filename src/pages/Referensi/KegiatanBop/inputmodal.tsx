...
const InputModal: React.FC<PageHeaderProps> = ({ isOpen, onClose, data }) => {
    // console.log(data)
    const localStorageName = "kegiatan-bop"
    const pathName = "kegiatan-bop"
    ...
    let submitData = async () => {
        ...
        try {
            await rService.saveOnline(reqBody, "reference-services", pathName, localStorageName);
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose}>
            <ModalHeader>{data ? "Edit" : "Tambah"} Kegiatan BOP </ModalHeader>
            <ModalBody>
