...
const PindahBukuModal: React.FC<PageHeaderProps> = ({ isOpen, onClose, data }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} className="w-full px-6 py-4 mx-2  bg-white  dark:bg-gray-800  sm:m-4 xl:max-w-screen-lg lg:max-w-screen-lg md:max-w-screen-md" >
      <ModalHeader>Lihat Nota Pindah Buku </ModalHeader>
      <ModalBody>
        <div >
          <div>
            <p className="text-bold">Nota Pindah Buku</p>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-2 my-4">
            ...
            <div className="flex-1">
              <div className="flex-1 text-gray-400">Ke Tipe Kas :</div>
              <div className="flex-1 mt-1 text-gray-400">-</div>       
            </div>
          </div>
          <div className="flex flex-col md:flex-row gap-2 my-4">
            <div className="flex-1 ">
              <div className="flex-1 text-gray-400">Ke No Rekening:</div>
              <div className="flex-1 mt-1 text-gray-400">-</div>              
            </div>
            <div className="flex-1">
              <div className="flex-1 text-gray-400">Ke Rekening Nama Atas :</div>
              <div className="flex-1 mt-1 text-gray-400">-</div>       
            </div>
          </div>
          <div className="flex flex-col md:flex-row gap-2 my-4">
            <div className="flex-1 ">
              <div className="flex-1 text-gray-400"> Ke Nama Bank :</div>
              <div className="flex-1 mt-1 text-gray-400">-</div>              
            </div>
            <div className="flex-1">
              <div className="flex-1 text-gray-400">Total :</div>
              <div className="flex-1 mt-1 text-gray-400">-</div>       
            </div>
          </div>
          <div className="flex flex-col md:flex-row gap-2 my-4 ">
...
export default PindahBukuModal;
