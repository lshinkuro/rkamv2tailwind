...
import PindahBukuModal from "./lihatNotaModal";
...
function PindahBuku() {
  ...
  const item = ["Home", "Realisasi", "PindahBuku", "List"];
            ...
            isShown && row.id === idRow ? (
              <>
                <div className="bg-white shadow-sm z-40 flex-1" style={{ position: 'fixed', zIndex: 1, right: 50 }}>
                  ...
                  {(kodeRole === "bendahara_madrasah" && (<LogButton onClick={() => { route.push('edit/id') }}>Edit</LogButton>))||null }                 
