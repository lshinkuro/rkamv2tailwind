...
const PengembalianModal: React.FC<PageHeaderProps> = ({ isOpen, onClose, data }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} className="w-full px-6 py-4 mx-2  bg-white  dark:bg-gray-800  sm:m-4 xl:max-w-screen-lg lg:max-w-screen-lg md:max-w-screen-md" >
      <ModalHeader>Lihat Nota Pengembalian Dana</ModalHeader>
      <ModalBody>
        <div >
          <div>
            <p className="text-bold">Nota Pengembalian Dana</p>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-2 my-4">
            ...
            <div className="flex-1">
              <div className="flex-1 text-gray-400">Nama Penerima :</div>
              <div className="flex-1 mt-1 text-gray-400">-</div>       
            </div>
          </div>
          <div className="flex flex-col md:flex-row gap-2 my-4">
            <div className="flex-1 ">
              <div className="flex-1 text-gray-400">No Rekening Penerima :</div>
              <div className="flex-1 mt-1 text-gray-400">-</div>              
            </div>
            <div className="flex-1">
              <div className="flex-1 text-gray-400">Nama Bank Penerima :</div>
              <div className="flex-1 mt-1 text-gray-400">-</div>       
            </div>
          </div>
          <div className="flex flex-col md:flex-row gap-2 my-4 ">
