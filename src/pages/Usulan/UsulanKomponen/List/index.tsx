...
const UsulanList = () => {
  ...
  const localItems = "usulanKomponen";
  ...
  const columns = [
      ...
      cell: (row) => (
        <div>
          <p className="text-xs text-gray-600 dark:text-gray-400">
            {row.no_tiket_format || row.usulan.no_tiket_format || "databaru"}
          </p>
        </div>
      ),
    },
    ...
    },
    {
      ...
      // selector: "usulan.usulan_komponen",
      sortable: true,
      cell: (row) => (
        <div>
          <p className="text-xs text-gray-600 dark:text-gray-400">
            {String(row.usulan.usulan_komponen)}
  ...
  const exportToXlsx = (apiData: any, fileName: any) => {
    ...
    apiData.forEach((el0: any) => {
      tmp0.push({
        ...
        UsulanKomponen: el0.usulan.usulan_komponen.toString(),
  ...
  return (
    <div>
      <BreadCrumb data={item} title="Usulan Komponen Madrasah" />
      <div className="m-5 p-5 bg-white shadow-md rounde">
        <div className="flex flex-row justify-between my-3">
          <div
            ...
            onClick={() => {
              exportToXlsx(dataTable, "usulan-komponen-list");
            }}
          >
