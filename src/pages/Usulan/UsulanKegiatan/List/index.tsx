...
const UsulanList = () => {
  const item = ["Home", "Usulan Kegiatan", "List"];
  const localItems = "usulankegiatan1";
      ...
      cell: (row) => (
        <div>
          <div className="flex items-center space-x-4">
            <div
              aria-label="details"
              className="bg-green-500 text-white  mx-0 px-2 py-1 rounded-md cursor-pointer hover:bg-green-600"
              title="Respon"
  ...
  return (
    <div>
      <BreadCrumb data={item} title="Usulan Kegiatan Madrasah" />
      ...
      <Modal isOpen={isModalOpen} onClose={hideDetails}>
        ...
        <ModalBody>
          ...
          {modalData?.status_usulan ? (
            <div className="flex flex-col p-2 border-t-2">
              <div className="flex flex-row">
                <div className="w-40">Status</div>
                <div className="flex flex-row">: {modalData?.status_usulan || ""}</div>
              </div>
            </div>
          ) : (
            ""
          ...
          {modalData?.respon ? (
            <div className="flex flex-col p-2 border-t-2">
              <div className="flex flex-row">
                <div className="w-40">Respon</div>
                <div className="flex flex-row">: {modalData?.respon || ""}</div>
              </div>
            </div>
          ) : (
            ""
          ...
          {userRole === "admin_pusat" ? (
            <div>
              <Label className="mt-4">
                ...
                <Select
                  className="mt-1"
                  defaultValue={modalData?.status_usulan || ""}
                  onChange={(e: any) => {
